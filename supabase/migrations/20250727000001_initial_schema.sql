...
-- ============================================
-- 12. KESEHATAN TABLE (additional health tracking)
-- ============================================
-- Not in original spec but useful for future
...
ALTER PUBLICATION supabase_realtime ADD TABLE public.doa;
ALTER PUBLICATION supabase_realtime ADD TABLE public.syukur;
ALTER PUBLICATION supabase_realtime ADD TABLE public.tidur;
...
ALTER PUBLICATION supabase_realtime ADD TABLE public.pmo;
